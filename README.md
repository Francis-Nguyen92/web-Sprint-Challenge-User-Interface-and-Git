...
Semantic HTML describes your content in your code, it is not used to style your page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

An inline will not take up the whole width of the page while a block will, also an inline does not cause a line break while a block does.
...
git is valuable because it allows cross coding between a team and organization to a project, allowing each person to use the most up to date code and keeping a log of changes made to the code so mistakes can be undone and fixed efficiently.
